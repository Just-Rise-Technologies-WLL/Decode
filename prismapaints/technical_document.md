...
- **Modular Components**:
  ...
  - `src/components/hero/ScrollHero.vue` (Hardware-Accelerated 60FPS Full-Screen Background Video using compressed `/video/hero_compressed.mp4` with Light Frosted Crystal Glass card and dark luxury typography)
